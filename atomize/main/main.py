...
class MainExtended(MainWindow):
    ...
    def set_control_center(self):
        ...
        button_name_1 = ["", "Set MF", "CW EPR", "TR EPR", "Set Temperature", "Oscilloscope"]
        ...
        actions_1 = [None, self.start_field_control, self.start_cw_control, self.start_tr_control, self.start_temp_control, self.start_osc_control]
    ...
    def start_experiment(self):
        ...
        # Rect/AWG phasing tool -- it holds the scope, so a second acquisition
        # would clash on the hardware.
    ...
    def start_cw_control(self):
        """
        A function to run the CW EPR control window.
        """
    ...
    def start_tr_control(self):
        """
        A function to run the TR (time-resolved) EPR control window.
        """
    ...
    def start_temp_control(self):
        """
        A function to run the temperature control window.
        """
