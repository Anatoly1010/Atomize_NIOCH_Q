...
cycle_data_x = np.zeros( real_length )
cycle_data_y = np.zeros( real_length )
data = np.zeros( (real_length, POINTS) )
###
...
for j in general.scans(SCANS):
    ...
    for i in range(POINTS):
        ...
        while k < PHASES:
            ...
            #cycle_data_x[k], cycle_data_y[k] = 
            cycle_data_x, cycle_data_y = a2012.oscilloscope_get_curve('CH1'), a2012.oscilloscope_get_curve('CH2')
