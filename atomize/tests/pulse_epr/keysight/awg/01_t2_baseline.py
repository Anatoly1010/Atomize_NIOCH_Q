...
PULSE_DETECTION = '1000 ns'
PULSE_1_START = general.const_shift(PULSE_AWG_1_START, 400)
PULSE_2_START = general.const_shift(PULSE_AWG_2_START, 400)
PULSE_SIGNAL_START = general.const_shift(PULSE_DETECTION, 400)
PHASES = 2
...
awg.awg_pulse(name = 'P4', channel = 'CH0', func = 'SINE', frequency = '2 MHz', phase_list = ['+x','-x'], \
            length = PULSE_1_LENGTH, sigma = PULSE_1_LENGTH, start = PULSE_AWG_1_START)
awg.awg_pulse(name = 'P5', channel = 'CH0', func = 'SINE', frequency = '2 MHz', phase_list = ['+x','+x'], \
...
real_length = 5000#a2012.oscilloscope_record_length( )
wind = 1000#a2012.oscilloscope_timebase() * 1000
