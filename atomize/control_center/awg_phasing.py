        ...
        try:
                    ...
                    for j in range(POINTS):
                        ...
                        if (not script_test) or j == 0:
                            if iq_cor == 0:
                                ...
                                area_x, area_y = t3104.oscilloscope_demodulate(data[0], data[1], iq_freq, zp, first_order, sec_order, integral = True)
                                if step != 1:
            ...
            if self.command == 'exit':
                ...
                if iq_cor == 0:
                    ...
                    data_x, data_y = t3104.oscilloscope_demodulate(data[0], data[1], iq_freq, zp, first_order, sec_order, integral = True)
                    if step != 1:
            ...
            for cycle in range(cycle_count):
                ...
                if a is not None and not script_test:
                    if iq_cor == 0:
                        ...
                        rdx, rdy = t3104.oscilloscope_demodulate(data[0], data[1], iq_freq, zp, first_order, sec_order, integral = True)
                        if step != 1:
