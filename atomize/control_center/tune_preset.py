...
class MainWindow(QMainWindow):
    ...
    def design(self):
        ...
        # ---- Boxes ----
        double_boxes = [(QDoubleSpinBox, "box_length", "cur_length", self.pulse_length, 4.0, 1900, 100.0, 4.0, 1, " ns"),
...
class Worker():
    ...
    def exp_on(self, conn, p2, p4, p5, p6, p7, p8, p9, p10):
        ...
        try:
            ...
            import atomize.device_modules.Lakeshore_335 as ptc_mod
            import atomize.general_modules.csv_opener_saver as openfile
